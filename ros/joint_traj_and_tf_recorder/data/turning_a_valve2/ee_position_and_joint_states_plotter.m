...
ax_ee.XAxis.Label.Position = ax_ee.XAxis.Label.Position + [20, -15, 0];
ax_ee.XAxis.Label.Rotation = 30;
% ax_ee.YTick = [-15 -11]; % fix specific to this dataset
ax_ee.Legend.Location = "south";
ax_ee.Legend.Position = ax_ee.Legend.Position - [0.02, -0.05, ax_ee.Legend.Position(3), ax_ee.Legend.Position(4)];
ax_ee.XAxis.FontSize = tick_fontsize - 17;
%--------------------------------------------------------------------------
...
js_end_index = 44; % specify end to truncate saturated readings
