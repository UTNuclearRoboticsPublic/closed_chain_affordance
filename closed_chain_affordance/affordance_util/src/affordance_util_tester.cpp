...
int main()
{
    ...
    using namespace AffordanceUtil;
    ...
    Blist << 0, 0, 0, 0, 0, 0, -1, 0, 1, 2, 0, 0, 0, 1, 0, 0, 0, 0.1;

    std::cout << "\nTesting FKinBody" << std::endl;
    std::cout << "Input M: \n" << M << std::endl;
    std::cout << "Input Blist: \n" << Blist << std::endl;
    std::cout << "Input thetalist: \n" << thetalist << std::endl;
    std::cout << "Output: \n" << FKinBody(M, Blist, thetalist) << std::endl;
    ...
    Eigen::MatrixXd Blist2(6, 4);
    Blist2 << 0, 1, 0, 1, 0, 0, 1, 0, 1, 0, 0, 0, 0, 2, 0, 0.2, 0.2, 0, 2, 0.3, 0.2, 3, 1, 0.4;
    std::cout << "\nTesting JacobianBody" << std::endl;
    std::cout << "Input Blist: \n" << Blist2 << std::endl;
    std::cout << "Input thetalist: \n" << thetalist2 << std::endl;
    std::cout << "Output: \n" << JacobianBody(Blist2, thetalist2) << std::endl;
