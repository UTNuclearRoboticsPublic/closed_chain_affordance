...
*/
#ifndef CLOSEDCHAIN_AFFORDANCE_UTIL
#define CLOSEDCHAIN_AFFORDANCE_UTIL

#include <Eigen/Core>
#include <Eigen/Geometry>

class ClosedChainAffordanceUtil {
public:
  ClosedChainAffordanceUtil();
  /**
   ...
   */
  Eigen::MatrixXd JacobianSpace(const MatrixXd &Slist,
   ...
   */
  Eigen::Matrix4d VecTose3(const Eigen::Vector6d &V){};
  /**
...
#endif // CLOSEDCHAIN_AFFORDANCE_UTIL
