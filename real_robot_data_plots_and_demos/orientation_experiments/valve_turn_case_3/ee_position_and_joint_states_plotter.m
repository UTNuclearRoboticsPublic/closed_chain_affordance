...
point_label_offset_z = 8;
labelpoints((df_pred{1:1, 'PredEEY'} * 1000), ...
     df_pred{1:1, 'PredEEZ'} * 1000+point_label_offset_z, point_labels(1:1),'N', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y = -14;
labelpoints((df_pred{2:4, 'PredEEY'} * 1000)+point_label_offset_y, ...
     df_pred{2:4, 'PredEEZ'} * 1000, point_labels(2:4),'SW', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y_1 = -14;
labelpoints((df_pred{5:7, 'PredEEY'} * 1000)+point_label_offset_y_1, ...
     df_pred{5:7, 'PredEEZ'} * 1000, point_labels(5:7),'W', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
labelpoints((df_pred{8:9, 'PredEEY'} * 1000)+point_label_offset_y_1, ...
     df_pred{8:9, 'PredEEZ'} * 1000, point_labels(8:9),'NW', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y_2 = -7;
labelpoints((df_pred{10:14, 'PredEEY'} * 1000)+point_label_offset_y_2, ...
     df_pred{10:14, 'PredEEZ'} * 1000, point_labels(10:14),'NW', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_z = 6;
labelpoints((df_pred{15:16, 'PredEEY'} * 1000), ...
     df_pred{15:16, 'PredEEZ'} * 1000 + point_label_offset_z, point_labels(15:16),'N', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y_3 = 8;
labelpoints((df_pred{17:21, 'PredEEY'} * 1000)+point_label_offset_y_3, ...
     df_pred{17:21, 'PredEEZ'} * 1000, point_labels(17:21),'NE', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y_4 = 12;
labelpoints((df_pred{22:end-1, 'PredEEY'} * 1000)+point_label_offset_y_4, ...
     df_pred{22:end-1, 'PredEEZ'} * 1000, point_labels(22:end-1),'E', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
point_label_offset_y_5 = 8;
labelpoints((df_pred{end:end, 'PredEEY'} * 1000)+point_label_offset_y_5, ...
     df_pred{end:end, 'PredEEZ'} * 1000, point_labels(end:end),'SE', 0.0, 1, 'Fontsize', point_label_font_size, 'Color', 'b');
hold on;
...
text(ax_ee_or, 3, -1.5, sprintf('r_p = %.3f*t %.3f', pred_polyfit_euler_x), ...
    'Rotation', -35, 'FontWeight', 'bold', 'FontSize',25, 'Color', 'r');
text(ax_ee_or, 2.6, -2.4, sprintf('r_a = %.3f*t %.3f', act_polyfit_euler_x), ...
    'Rotation', -35, 'FontWeight', 'bold', 'FontSize',25, 'Color','#f08080');
