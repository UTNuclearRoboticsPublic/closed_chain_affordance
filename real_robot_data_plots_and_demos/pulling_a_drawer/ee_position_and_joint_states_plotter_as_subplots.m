...
ax_ee.YAxis.Label.Position = ax_ee.YAxis.Label.Position + [57, -35, 0];
...
ax_ee.YAxis.FontSize = tick_fontsize-5;
...
ax_ee.Legend.Location = "southeast";
ax_ee.Title.FontSize = title_fontsize;

% Subplot for joint states
ax_joint_states = subplot(1, 2, 2, 'Parent', fig, 'Position', [0.5, 0.1, 0.4, 0.8]);
...
for i = 1:length(joint_names)
    ...
    plot(ax_joint_states, manual_timestamps(1:js_end_index), df_act{:,joint}(1:js_end_index), 'LineWidth', 5, 'DisplayName', joint);
